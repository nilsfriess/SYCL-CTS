...
TEST_CASE("reduction_with_identity_param_item_twice_fp16", "[reduction]"){
  auto queue = sycl_cts::util::get_cts_object::queue();
...
TEST_CASE("reduction_with_identity_param_even_item_fp16", "[reduction]"){
  auto queue = sycl_cts::util::get_cts_object::queue();
...
TEST_CASE("reduction_with_identity_param_no_one_item_fp16", "[reduction]"){
  auto queue = sycl_cts::util::get_cts_object::queue();
